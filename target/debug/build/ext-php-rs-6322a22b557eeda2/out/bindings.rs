...
pub type _zend_known_string_id = ::std::os::raw::c_int;
extern "vectorcall" {
    #[link_name = "\u{1}zend_hash_clean@@8"]
    pub fn zend_hash_clean(ht: *mut HashTable);
}
extern "vectorcall" {
    #[link_name = "\u{1}zend_hash_str_update@@32"]
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_hash_index_del@@16"]
    pub fn zend_hash_index_del(ht: *mut HashTable, h: zend_ulong) -> zend_result;
}
extern "vectorcall" {
    #[link_name = "\u{1}zend_hash_str_find@@24"]
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_hash_get_current_key_type_ex@@16"]
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_array_dup@@8"]
    pub fn zend_array_dup(source: *mut HashTable) -> *mut HashTable;
}
extern "vectorcall" {
    #[link_name = "\u{1}zend_array_destroy@@8"]
...
extern "vectorcall" {
    #[link_name = "\u{1}gc_possible_root@@8"]
...
pub type php_win32_ioutil_dev_t = ::std::os::raw::c_ulonglong;
pub type php_win32_ioutil_ino_t = ::std::os::raw::c_ulonglong;
pub type php_win32_ioutil_time_t = __time64_t;
pub type php_win32_ioutil_size_t = ::std::os::raw::c_longlong;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct php_win32_ioutil_stat_t {
    pub st_dev: php_win32_ioutil_dev_t,
    pub st_ino: php_win32_ioutil_ino_t,
    pub st_mode: ::std::os::raw::c_uint,
    pub st_nlink: ::std::os::raw::c_uint,
    pub st_uid: ::std::os::raw::c_ushort,
    pub st_gid: ::std::os::raw::c_ushort,
    pub st_rdev: php_win32_ioutil_dev_t,
    pub st_size: php_win32_ioutil_size_t,
    pub st_atime: php_win32_ioutil_time_t,
    pub st_mtime: php_win32_ioutil_time_t,
    pub st_ctime: php_win32_ioutil_time_t,
}
pub type zend_stat_t = php_win32_ioutil_stat_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type zend_error_handling_t = ::std::os::raw::c_int;
...
pub type _zend_prop_purpose = ::std::os::raw::c_int;
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_is_identical@@16"]
    pub fn zend_is_identical(op1: *const zval, op2: *const zval) -> bool;
}
extern "vectorcall" {
    #[link_name = "\u{1}instanceof_function_slow@@16"]
...
pub type zif_handler = ::std::option::Option<
    unsafe extern "vectorcall" fn(execute_data: *mut zend_execute_data, return_value: *mut zval),
>;
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_objects_store_del@@8"]
...
pub type zend_memoize_mode = ::std::os::raw::c_int;
#[repr(C)]
pub struct _zend_executor_globals {
    ...
    pub windows_version_info: OSVERSIONINFOEX,
...
extern "vectorcall" {
    #[link_name = "\u{1}zend_fetch_function_str@@16"]
...
pub type _zend_expected_type = ::std::os::raw::c_int;
extern "vectorcall" {
    #[link_name = "\u{1}zend_wrong_parameters_count_error@@16"]
    pub fn zend_wrong_parameters_count_error(min_num_args: u32, max_num_args: u32);
}
pub type uid_t = ::std::os::raw::c_int;
...
pub type php_stream_filter_status_t = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct _php_core_globals {
    ...
    pub windows_show_crt_warning: bool,
...
pub type sapi_header_op_enum = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
